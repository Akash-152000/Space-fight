...
images=[pygame.image.load("graphics\R1.png"),pygame.image.load("graphics\R2.png"),pygame.image.load("graphics\R3.png"),pygame.image.load("graphics\R4.png"),pygame.image.load("graphics\R5.png"),pygame.image.load("graphics\R6.png"),pygame.image.load("graphics\R7.png"),pygame.image.load("graphics\R8.png")]
sun_image=pygame.image.load("graphics\planet-2.png")
cloud_image=pygame.image.load("graphics\cloud-1.png")
back=pygame.image.load("graphics\\back-land.png")
back2=pygame.image.load("graphics\\back-land.png")
back_sky=pygame.image.load("graphics\\back-sky.png")
